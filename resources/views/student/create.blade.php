...
@section('content')
    <x-guest-layout>
        <x-auth-card>
            ...
            <h3 class="text-center">Ajouter un étudiant </h3>
            <!-- Validation Errors -->
            <x-auth-validation-errors class="mb-4" :errors="$errors" />

            <form method="POST" action="{{route('students_create')}}" enctype="multipart/form-data">
                @csrf
